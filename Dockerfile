...
RUN apt-get update
RUN apt install -y build-essential git clang cmake  automake autotools-dev libtool zlib1g zlib1g-dev libexif-dev libssl-dev
#ADD . /mongo-c-driver
RUN git clone https://github.com/baptistapedro/mongo-c-driver.git --branch master
...
ADD fuzzers/json-to-bson.c .
RUN afl-gcc -I ./src/ -L. json-to-bson.c -o fuzzer -lbson-1.0
